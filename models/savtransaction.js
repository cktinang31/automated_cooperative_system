...
const SavModel = (sequelize) => {
   ...
   Savtransaction.associate = (models) => {
        Savtransaction.belongsTo(models.User, {
            foreignKey: 'user_id',
            onDelete: 'CASCADE',
            onUpdate: 'CASCADE'
        });
        
        Savtransaction.belongsTo(models.Savings, {
